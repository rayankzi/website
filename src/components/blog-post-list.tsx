  ...
  return (
    <div
      className={`flex flex-col ${
        isOverview || isBlogFooter ? "gap-4" : "gap-8"
      }`}
    >
      {isOverview || isBlogFooter ? (
        <>
          <div className="pb-1">
            <span className="text-2xl font-medium">
              {isBlogFooter ? "You may also like" : "Recent Posts"}
            </span>
            {isOverview && <p>What I&apos;ve been up to lately</p>}
          </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="relative max-w-md">
              <div className="relative">
                <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-low-contrast-text" />
                <Input
                  type="text"
                ...
                {searchTerm && (
                  ...
                  >
                    <X className="h-4 w-4 text-low-contrast-text" />
                  </Button>
                )}
              </div>
              {searchTerm && (
                <div className="mt-2 text-sm text-low-contrast-text">

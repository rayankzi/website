...
function CodeBlock({ cursor, className, ...props }: CodeBlockProps) {
  ...
  return (
    <CodeBlockPrimitive
      ...
      className={cn(
        "relative text-sm px-4 overflow-auto",
        "[&>pre]:!p-0 [&>pre,_&_code]:!bg-transparent [&>pre,_&_code]:[background:transparent_!important] [&>pre,_&_code]:border-none [&_code]:!text-[13px] [&_code_.line]:!px-0",
        cursor &&

...
<Code>
  ...
  <CodeBlock lang="bash" />
  <CodeBody>{`npm i -g vercel`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>bash</CodeHeader>
  <CodeBlock lang="bash" />
  <CodeBody>{`npx create-next-app@latest`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>next.config.js</CodeHeader>
  <CodeBlock lang="javascript" />
  <CodeBody>{`/** @type {import('next').NextConfig} */
  const nextConfig = {
    experimental: {
      serverActions: true,
    },
  ...
  module.exports = nextConfig;`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>bash</CodeHeader>
  <CodeBlock lang="bash" />
  <CodeBody>{`npm i --save-dev prisma
  npm i @prisma/client`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>bash</CodeHeader>
  <CodeBlock lang="bash" />
  <CodeBody>{`vercel link
  vercel env pull .env.local`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>bash</CodeHeader>
  <CodeBlock lang="bash" />
  <CodeBody>{`npx prisma init`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>prisma/schema.prisma</CodeHeader>
  <CodeBlock lang="bash" />
  <CodeBody>{`generator client {
...
<Code>
  <CodeHeader copyButton>bash</CodeHeader>
  <CodeBlock lang="bash" />
  <CodeBody>{`npx prisma db push
  npx prisma generate`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>src/app/lib/prisma.ts</CodeHeader>
  <CodeBlock lang="typescript" />
  <CodeBody>{`import { PrismaClient } from "@prisma/client";
  ...
  export default prisma;`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>src/app/page.tsx</CodeHeader>
  <CodeBlock lang="typescript" />
  <CodeBody>{`import prisma from "@/lib/prisma";
...
<Code>
  <CodeHeader copyButton>src/app/page.tsx</CodeHeader>
  <CodeBlock lang="typescript" />
  <CodeBody>{`import Link from "next/link";
...
<Code>
  <CodeHeader copyButton>src/app/edit/page.tsx</CodeHeader>
  <CodeBlock lang="typescript" />
  <CodeBody>{`export default async function Edit() {}`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>typescript</CodeHeader>
  <CodeBlock lang="typescript" />
  <CodeBody>{`async function createBook(data: FormData) {
    "use server";
    ...
  }`}</CodeBody>
</Code>
...
<Code>
  ...
  <CodeBlock lang="tsx" />
  <CodeBody>{`<form action={createBook}>
    ...
  </form>`}</CodeBody>
</Code>

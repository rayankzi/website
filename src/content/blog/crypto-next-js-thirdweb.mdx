...
<Code>
  <CodeHeader copyButton>bash</CodeHeader>
  <CodeBlock lang="bash" />
  <CodeBody>{`npm i @3rdweb/hooks @3rdweb/sdk @3rdweb/react ethers # npm
  yarn add @3rdweb/hooks @3rdweb/sdk @3rdweb/react ethers # yarn`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>pages/_app.tsx</CodeHeader>
  <CodeBlock lang="jsx" />
  <CodeBody>{`import "../styles/globals.css";
...
<Code>
  <CodeHeader copyButton>index.tsx</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`const { address, connectWallet } = useWeb3();`}</CodeBody>
</Code>
...
<Code>
  ...
  <CodeBlock lang="jsx" />
  <CodeBody>{`<a onClick={() => connectWallet("injected")}></a>`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>MintToken.tsx</CodeHeader>
  <CodeBlock lang="tsx" />
  <CodeBody>{`const MintToken = () => {
    return <div>Mint token</div>;
  };
  
  export default MintToken;`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>MintToken.tsx</CodeHeader>
  <CodeBlock lang="tsx" />
  <CodeBody>{`<a className="group relative inline-block focus:outline-none focus:ring">
...
<Code>
  <CodeHeader copyButton>MintToken.tsx</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`const { provider } = useWeb3();`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>MintToken.tsx</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`const amount = ethers.utils.parseUnits("5", 18);
  const mintToken = useCallback(() => {
    tokenModule?.mint(amount);
  }, [tokenModule, amount]);`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>MintToken.tsx</CodeHeader>
  <CodeBlock lang="tsx" />
  <CodeBody>{`import { useWeb3 } from "@3rdweb/hooks";

...
<Code>
  ...
  # Yarn
  yarn create next-app --example with-tailwindcss with-tailwindcss-app`}</CodeBody>
</Code>
...
<Code>
  ...
  # Yarn
  yarn add @headlessui/react`}</CodeBody>
</Code>

Then inside our app, you can delete everything inside of `index.js` and add the following:

<Code>
  <CodeHeader copyButton>index.js</CodeHeader>
  <CodeBlock lang="jsx" />
  <CodeBody>{`const HomePage = () => {
    return (
      <div>
        <Head>
...
<Code>
  <CodeHeader copyButton>components/Modal.js</CodeHeader>
  <CodeBlock lang="jsx" />
  <CodeBody>{`const Modal = () => {
    return <div>The Modal is Here!</div>;
  };
  
  export default Modal;`}</CodeBody>
</Code>
...
<Code>
  ...
  <CodeBlock lang="jsx" />
  <CodeBody>{`const [open, setOpen] = useState(false);`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>jsx</CodeHeader>
  <CodeBlock lang="jsx" />
  <CodeBody>{`<Dialog open={open} onClose={() => setOpen(false)}></Dialog>`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>jsx</CodeHeader>
  <CodeBlock lang="jsx" />
  <CodeBody>{`<Dialog open={open} onClose={() => setOpen(false)}>
...
<Code>
  <CodeHeader copyButton>jsx</CodeHeader>
  <CodeBlock lang="jsx" />
  <CodeBody>{`<Dialog.Title>Update Sucessful</Dialog.Title>
  <Dialog.Description>
    Profile updated successfully ✅
  </Dialog.Description>`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>jsx</CodeHeader>
  <CodeBlock lang="jsx" />
  <CodeBody>{`<span className="inline-block h-screen align-middle" aria-hidden="true">
    &#8203;
  </span>`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>jsx</CodeHeader>
  <CodeBlock lang="jsx" />
  <CodeBody>{`<div className="fixed inset-0 flex items-center justify-center">
    <a

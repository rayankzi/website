...
<Code>
  ...
  <CodeBlock lang="ts" />
  <CodeBody>{`export interface Book {
    name: string;
    author: string;
    datePublished: Date;
    price: number;
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`type BookInfo = Omit<Book, "price" | "numSales">;`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`interface IBookInfo extends Omit<Book, "price" | "numSales"> {}`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`type BookInfo = Pick<Book, "name" | "author" | "datePublished" | "seriesName">;`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`type BookPartial = Partial<Book>;`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`type BookRequired = Required<Book>;`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`type BookPartial = Partial<Book> & { name: string };`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`const myObj: Record<string, number> = {
    a: 1,
    b: 2,
  };`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`const shelf: Record<number, Book> = {
    0: {
      name: "Into Thin Air",
      author: "Jon Krakauer",
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`function createPost(caption: string, image?: string) {
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`type CreatePostInput = Parameters<typeof createPost>;`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`const post: CreatePostInput = ["Nice", "https://bit.ly/3OOiIaC"];
  createPost(...post);`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`type CreatePostReturn = ReturnType<typeof createPost>;`}</CodeBody>
</Code>
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`type CreatePostReturn = {
    caption: string;
...
<Code>
  <CodeHeader copyButton>ts</CodeHeader>
  <CodeBlock lang="ts" />
  <CodeBody>{`type CreatePostReturn = Awaited<ReturnType<typeof createPost>>;`}</CodeBody>
</Code>
